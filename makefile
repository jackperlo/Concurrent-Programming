...
$(TARGET): $(OBJMASTER) $(OBJTAXI) $(OBJSOURCE) $(OBJCOMMON)
	...
	$(CC) -D SO_HEIGHT=$(SO_HEIGHT) -D SO_WIDTH=$(SO_WIDTH) $(OBJTAXI) $(COMPILATION_FLAGS) -o Taxi
	$(CC) -D SO_HEIGHT=$(SO_HEIGHT) -D SO_WIDTH=$(SO_WIDTH) $(OBJSOURCE) $(COMPILATION_FLAGS) -o Source
